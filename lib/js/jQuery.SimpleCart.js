(function ($, window, document, undefined) {
    ...
    $.extend(simpleCart.prototype, {
        ...
        _setupCart: function () {
            ...
            this.cart_ele.append("<div class='panel-heading cart-heading carrinho-banner'><div class='total-cart-count'>Seu carrinho 0 items</div</div>")
            ...
            this.cart_ele.append("<div class='cart-summary-container'>\n\
                                <div class='cart-offer'></div>\n\
                                        <div class='cart-total-amount amonut-card'>\n\
                                            <div>Total</div>\n\
        ...
        _updateCartDetails: function () {
            ...
            $(this.options.totalCartCountClass).html("Seu carrinho " + mi._totalCartCount() + " items");
            $(this.options.totalCartCostClass).html("R$" + mi._totalCartCost());
        },
        ...
        _displayCart: function () {
            ...
            if (cartArray.length <= 0) {
                output = "<h4>Seu carrinho está vazio</h4>";
            }
